            ...
            <View style = { styles.container }>
                ...
                <Animated.View style = {[ styles.animatedHeader, { height: headerHeight, backgroundColor: headerBackgroundColor } ]}>
                    ...
                    <View style={{position: 'absolute', width: d.width-32, height: '100%'}}>
                      <Card onPress={() => { if(Platform.OS != 'ios') StatusBar.setBackgroundColor('#FF9E02'); if(Platform.OS != 'ios') StatusBar.setTranslucent(false); goBack();}} elevation={5} style={{width: 36, height: 36, borderRadius: 1000,  marginTop: 42, position: 'absolute'}}>
                        <TouchableOpacity>
