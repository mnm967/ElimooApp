...
var myInterval;
class DealCompleteView extends Component
{
    constructor(props)
    {
        super(props);
            ...
            <View style = { styles.container }>
                <ScrollView 
                    ...
                    <View style={{padding: 16}}>
                      <Text style={styles.deal_title}>Discount Approved!</Text>
                      <View style={{flex: 1, flexDirection: 'row', alignSelf: 'center', marginTop: 8}}>
                          <Icon name="check" size={96} color="#FF9E02" />
                      </View>
                    </View>
                      <TouchableOpacity ref={component => this.touchable = component} onPress={() => this.resetStack()}><Button labelStyle={{fontFamily: 'Nunito-SemiBold', fontSize: 17, textTransform: 'none'}} color='#fff' style={styles.deal_button}>Done</Button></TouchableOpacity>
...
export default connect(mapStateToProps, mapDispatchToProps)(DealCompleteView);